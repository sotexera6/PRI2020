      ...
      <html>
          ...
          <body>
              ...
              <div class="w3-container w3-teal">
                  <h2>File List
                    <a href="http://localhost:7701/files/upload">
                        <button class="w3-button w3-round-xxlarge w3-text-teal w3-white w3-large w3-right w3-margin-bottom">
                            <b>+</b>
                        </button>
                    </a>  
                  </h2>
    ...
    <html>
        ...
        <body>
            ...
            <form class="w3-container" action="/files" method="POST" enctype="multipart/form-data">
                ...
                <input class="w3-btn w3-blue-grey w3-margin-top" type="submit" value="Submit"/>
                <input class="w3-btn w3-blue-grey w3-margin-top w3-margin-left" value="+" style="width:55px;" onclick='addOne();'/>
            </form>

            <footer class="w3-container w3-teal">
                <address>
                    Gerado por galuno::PRI2020 em ${d}
                    <a class="w3-right" href="http://localhost:7701/">
                        Voltar
                    </a>  
                </address>
            </footer>
